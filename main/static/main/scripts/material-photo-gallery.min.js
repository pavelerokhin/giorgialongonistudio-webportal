        ...
        !(function (n, s) {
          ...
          function r(t) {
            if (_ && v) {
              ...
              Math.abs(n) > Math.abs(s) &&
                (n > 0 ? this._handleNext() : this._handlePrev()),
                (_ = null),
                (v = null);
            }
          }
          ...
          return (
            ...
            (l.prototype._bindEvents = function () {
              for (var t = 0, e = this._thumbs.length; t < e; t++)
              ...
              this._closeBtn.addEventListener(
                ...
                document.addEventListener("touchmove", r.bind(this));
            }),
            (l.prototype._handleScroll = n(function () {
              this._resetFullImg.call(this);
            }, 25)),
            (l.prototype._handleResize = function () {
              this._resetFullImg.call(this);
            }),
            (l.prototype._loadFullImgs = function () {
              for (var t, e, i = 0, n = this._thumbs.length; i < n; i++)
            ...
            (l.prototype._activateFullImg = function () {
              this._thumb.classList.add("hide"),
                ...
                (this._fullImg.style[a] = "translate3d(0,0,0)"),
                (this._fullImgOpen = !0),
            ...
            (l.prototype._closeFullImg = function () {
              var t = function () {
                this._fullBox.classList.remove("active"),
                  ...
                  (this._fullImg.style[a] = this._fullImgsTransforms[
                    this._thumbIndex
                  ]),
                ...
                var t = function () {
                  this._fullImg.classList.remove("active"),
                    this._fullImg.removeEventListener(m, t),
                    (this._fullImgOpen = !1);
                }.bind(this);
            ...
            (l.prototype._changeImg = function (t) {
              (this._thumbIndex = this._fullImgs.indexOf(this._fullImg)),
                ...
                (this._newFullImg.style[a] = "translate3d(0,0,0)"),
                this._fullImg.classList.remove("active"),
                (this._fullImg.style[a] = this._fullImgsTransforms[
                  this._thumbIndex - 1
                ]),
